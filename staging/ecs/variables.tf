...
variable "erp_svc_secrets" {
  default = [
    {
      "name" : "DB_USERNAME"
      "valueFrom" : "/staging/erp/mysql_user"
    },
    {
      "name" : "DB_PASSWORD"
      "valueFrom" : "/staging/erp/mysql_password"
    },
    {
      "name" : "MAIL_FROM_NAME"
      "valueFrom" : "/staging/erp/mail_from_name"
    },
    {
      "name" : "APP_KEY"
      "valueFrom" : "/staging/erp/app_key"
    },
    {
      "name" : "MAIL_PASSWORD"
      "valueFrom" : "/staging/erp/mail_password"
    },
    {
      "name" : "MAIL_USERNAME"
      "valueFrom" : "/staging/erp/mail_username"
    }
  ]
}
